...
import '../Components/CSS/Page3.css'
...
function PageN3() {
  return (
    <>
      <Navbar/>
      <Topimage2 image={topimage2} title={"MULTI-VITAMIN"}/>
      <div className='divs-container-p3'>
        <div className="div1-p3">
            <h3>New Collection For GOOD4ME <br /> Care Products</h3>
            <div className='img-wrap'><img src={simage2} alt="" /></div>
        </div>
        <div className="div2-p3">
            <img src={image19} alt="" />
            <img src={image18} alt="" />
        </div>
      </div>
      <div className="div3-p3">
          <div>
            <img src={rectengle30} alt="" />
          </div>
          <div className="rectangle-container-p3">
