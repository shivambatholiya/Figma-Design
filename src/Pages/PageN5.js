...
import '../Components/CSS/Page5.css'
import Topimage3 from '../Components/TopImage3'
...
function PageN5() {
  return (
    <>
      <Navbar/>
      <Topimage3 image={fruits} title={"STRONG IMMUNITY"}/>
      <div className='divs-container-p5'>
        <div className="div1-p5">
            <h3>New Collection For GOOD4ME <br /> Care Products</h3>
            <div className='img-wrap'><img src={simage2} alt="" /></div>
        </div>
        <div className="div2-p5">
            <img src={image19} alt="" />
            <img src={image18} alt="" />
        </div>
      </div>
      <div className="div3-p5">
          <div>
            <img src={rectengle30} alt="" />
          </div>
          <div className="rectangle-container-p5">
